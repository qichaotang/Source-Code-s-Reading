...
namespace apex_tensor{
    ...
    namespace cpu_only{
        ...
        inline TENSOR_FLOAT dot( const CTensor1D &a, const CTensor1D &b );  // µ„≥À
    };
};
...
namespace apex_tensor{
    namespace tensor{    
         ...
         */        
        _INLINE void dot_lt( _Tensor2D &dst, const _Tensor1D &lhs, const _Tensor1D &rhs );  // dst = lhs.T * rhs£¨º¥“ªŒ¨∂»æÿ’Û * “ªŒ¨∂»æÿ’Û = ∂˛Œ¨∂»æÿ’Û
